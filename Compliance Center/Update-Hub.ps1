...
Invoke-WebRequest -Uri https://raw.githubusercontent.com/microsoft/WKSPlus-M365SCC/main/Compliance%20Center/Download-Hub-IRM.ps1 -OutFile "$($LogPath)Download-Hub-IRM.ps1" -ErrorAction Stop
